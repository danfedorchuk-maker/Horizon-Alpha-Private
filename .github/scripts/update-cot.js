...
const MARKETS = [
  ...
  { name: 'SILVER',             query: 'SILVER+-+COMMODITY+EXCHANGE+INC.' },
...
async function main() {
  ...
  const lines = [
    ...
    `    "SILVER":             { oi: ${r['SILVER'].oi}, longSpec: ${r['SILVER'].longSpec}, shortSpec: ${r['SILVER'].shortSpec}, longComm: ${r['SILVER'].longComm}, shortComm: ${r['SILVER'].shortComm} },`,
